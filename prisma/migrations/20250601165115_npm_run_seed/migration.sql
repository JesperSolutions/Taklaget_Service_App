...
CREATE TABLE "Checklist" (
    ...
    "accessComments" TEXT,
    "fallProtection" TEXT NOT NULL,
    "fallProtectionComments" TEXT,
    "existingRoofMaterial" TEXT,
    "roofAge" INTEGER,
    "roofArea" REAL,
    "technicalExecution" TEXT,
    "welds" TEXT,
    "drainage" TEXT,
    "edgesAndCrowns" TEXT,
    "skylights" TEXT,
    "technicalInstallations" TEXT,
    "insulationType" TEXT,
    "greenRoof" TEXT,
    "solarPanels" TEXT,
    "noxTreatment" TEXT NOT NULL,
    "rainwaterCollection" TEXT NOT NULL,
    "recreationalAreas" TEXT NOT NULL,
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL,
    CONSTRAINT "Checklist_reportId_fkey" FOREIGN KEY ("reportId") REFERENCES "Report" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
-- CreateIndex
CREATE UNIQUE INDEX "Checklist_reportId_key" ON "Checklist"("reportId");
